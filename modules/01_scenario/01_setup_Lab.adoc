...
For those that may be interested in provisioning this Halkyon lab environment in their own OpenShift cluster, the instructions for doing so can be found link:[here].

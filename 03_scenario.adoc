...
'fruit-client-sb' component was not found, initializing it
 ...
 ✓  Uploading /home/amunozhe/git/hal/fruit-client-sb/target/fruit-client-sb-1.0.0-SNAPSHOT.jar
'fruit-backend-sb' component was not found, initializing it
 ✓  Waiting for component fruit-backend-sb to be ready…
 ✓  Uploading /home/amunozhe/git/hal/fruit-backend-sb/target/fruit-backend-sb-1.0.0-SNAPSHOT.jar
----

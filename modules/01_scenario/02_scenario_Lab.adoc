...
-----
oc describe crd components.halkyon.io --as=system:admin
...
+
-----
oc describe crd capabilities.halkyon.io --as=system:admin
-----
...
+
-----
oc describe crd links.halkyon.io --as=system:admin
-----
...
. Assign `user1` as a cluster-admin:
+
-----
oc adm policy add-cluster-role-to-user cluster-admin user1 --as=system:admin
-----

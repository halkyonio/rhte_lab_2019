...
Execute the command `bash <(curl -s https://raw.githubusercontent.com/halkyonio/rhte_lab_2019/master/scripts/git-create.sh)` in a terminal.
...
and is running at this address: `https://<OCP4_CLUSTER>/k8s/ns/kubedb/pods`
+
...
It is available at this address: `https://<OCP4_CLUSTER>/k8s/ns/kubedb/pods`
----
Log stream paused.
|
69 lines
...
It is available at this address: `https://<OCP4_CLUSTER>/k8s/ns/tekton-pipelines/pods/`
+
----
Log streaming...
|

...
echo "curl -u "$username:$token" https://api.github.com/orgs/$org_name/repos -d '{"name":"'$repo_name'", "description":"My cool '$repo_name'", "private": false, "has_issues": false, "has_projects": true, "has_wiki":false }'"

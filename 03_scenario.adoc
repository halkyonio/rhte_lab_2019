...
----
# curl -L https://github.com/halkyonio/hal/releases/download/v0.1.10/hal_0.1.10_Darwin_x86_64.tar.gz | tar -xz -C /usr/local/bin/ && chmod +x /usr/local/bin/hal
----

==== Binary installation for Linux

----
# curl -L https://github.com/halkyonio/hal/releases/download/v0.1.10/hal_0.1.10_Linux_x86_64.tar.gz \
    -o /usr/local/bin/hal_0.1.10_Linux_x86_64.tar.gz && \
    tar -xzf /usr/local/bin/hal_0.1.10_Linux_x86_64.tar.gz && \
...
----
docker run --rm --name hal -v "/path/to/lab/dir:/home/lab" -it quay.io/halkyonio/hal:v0.1.10 <COMMAND>
----
...
----
docker run --rm --name hal -v "/path/to/lab/dir:/home/lab" -it quay.io/halkyonio/hal:v0.1.10 oc login <SERVER_ADDRESS> -u user1 -p r3dh4t1!
----

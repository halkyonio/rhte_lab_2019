...
=== Optional:  Install _hal_ utility
...
The following is provided if you desire the _hal_ utility installed in a different environment.
...
# curl -L https://github.com/halkyonio/hal/releases/download/v0.1.9/hal_0.1.9_Linux_x86_64.tar.gz \
    ...
    tar -xzf /usr/local/bin/hal_0.1.9_Linux_x86_64.tar.gz -C /usr/local/bin && \
